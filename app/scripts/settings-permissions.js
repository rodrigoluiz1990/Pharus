...
const SettingsPermissionsModule = (() => {
    ...
    const SCREENS = [
        ...
        { key: 'atendimento', label: 'Atendimento', options: ['view', 'create', 'edit', 'delete', 'assign', 'comment', 'attachment', 'link_task'] },
    ...
    const OPTION_LABELS = {
        ...
        assign: 'Vincular responsaveis',
        comment: 'Comentar',
        link_task: 'Vincular tarefas',
        export: 'Exportar',
